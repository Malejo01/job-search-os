...
- **Pendiente de tráfico real:** confirmar que una alerta de LinkedIn entra parseada y sus ofertas quedan en pendientes de JD, y que el dedup las cruza con las cargadas desde los `.eml` de fixtures.
