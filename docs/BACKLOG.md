...
- **Por qué:** una fusión errónea pisó el JD de un aviso (Avenga Loyalty) y solo se recuperó porque Neon guarda 6 h de historial. Fue suerte, no una garantía del sistema.
